    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" style={{ /*background: '#2E3B55'*/ }}>
        <Toolbar variant="dense">
          <Box component="img" src="logo400x120-white.png" alt="logo" sx={{ width: '120px' }}/>
          <Typography
            variant="h4"
            noWrap
            component="div"
          ...
          <Box sx={{ display: { xs: 'flex', md: 'flex' } }}>
            <Button variant="text" className="LinkAppBar" component={RouterLink} 
            to="/">Accueil</Button>
            <Button variant="text" className="LinkAppBar" component={RouterLink} 
            to="/social">Réseau social</Button>
            <Button variant="text" className="LinkAppBar" component={RouterLink} 
            to="/marketplace">Marketplace</Button>
            <Button variant="text" className="LinkAppBar" component={RouterLink} 
            to="/car">Mes véhicules</Button>
            <Button variant="text" className="LinkAppBar" component={RouterLink} 
            to="/about">A propos</Button>
          </Box>
          <Box sx={{ display: { xs: 'flex', md: 'flex' } }}>
            <IconButton
              size="large"
